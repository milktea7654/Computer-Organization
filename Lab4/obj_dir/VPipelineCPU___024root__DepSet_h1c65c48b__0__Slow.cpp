...
VL_ATTR_COLD void VPipelineCPU___024root___eval_initial(VPipelineCPU___024root* vlSelf) {
    ...
    vlSelf->__Vtrigrprev__TOP__PipelineCPU__DOT__ALU_result_mem 
...
VL_ATTR_COLD void VPipelineCPU___024root___eval_initial__TOP(VPipelineCPU___024root* vlSelf) {
    ...
    VL_READMEM_N(false, 8, 128, 0, VL_CVT_PACK_STR_NW(6, __Vtemp_hd0a1b870__0)
                 ...
                 , 0, ~0ULL);
    vlSelf->PipelineCPU__DOT__BrEq = 0U;
    vlSelf->PipelineCPU__DOT__BrLT = 0U;
}
...
VL_ATTR_COLD void VPipelineCPU___024root___dump_triggers__act(VPipelineCPU___024root* vlSelf) {
    ...
    if (vlSelf->__VactTriggered.at(3U)) {
        VL_DBG_MSGF("         'act' region trigger index 3 is active: @([changed] PipelineCPU.ALU_result_mem or [changed] PipelineCPU.memRead_mem)\n");
    }
}
#endif  // VL_DEBUG
...
VL_ATTR_COLD void VPipelineCPU___024root___dump_triggers__nba(VPipelineCPU___024root* vlSelf) {
    ...
    if (vlSelf->__VnbaTriggered.at(3U)) {
        VL_DBG_MSGF("         'nba' region trigger index 3 is active: @([changed] PipelineCPU.ALU_result_mem or [changed] PipelineCPU.memRead_mem)\n");
    }
}
#endif  // VL_DEBUG
...
VL_ATTR_COLD void VPipelineCPU___024root___ctor_var_reset(VPipelineCPU___024root* vlSelf) {
    ...
    vlSelf->PipelineCPU__DOT__inst_WB = VL_RAND_RESET_I(32);
    vlSelf->PipelineCPU__DOT__regWrite = VL_RAND_RESET_I(1);
    vlSelf->PipelineCPU__DOT__regWrite_WB = VL_RAND_RESET_I(1);
    vlSelf->PipelineCPU__DOT__write_back = VL_RAND_RESET_I(32);
    ...
    vlSelf->PipelineCPU__DOT__ALU_in = VL_RAND_RESET_I(32);
    vlSelf->PipelineCPU__DOT__Mux_ALU = VL_RAND_RESET_I(32);
    vlSelf->PipelineCPU__DOT__ALUCtl = VL_RAND_RESET_I(4);
    vlSelf->PipelineCPU__DOT__mem_data = VL_RAND_RESET_I(32);
    vlSelf->PipelineCPU__DOT__PC_ID = VL_RAND_RESET_I(32);
    vlSelf->PipelineCPU__DOT__PC_plus4_ID = VL_RAND_RESET_I(32);
    vlSelf->PipelineCPU__DOT__inst_ID = VL_RAND_RESET_I(32);
    vlSelf->PipelineCPU__DOT__PC_plus4_WB = VL_RAND_RESET_I(32);
    vlSelf->PipelineCPU__DOT__PC_plus4_MEM = VL_RAND_RESET_I(32);
    vlSelf->PipelineCPU__DOT__imm_ID = VL_RAND_RESET_I(32);
    vlSelf->PipelineCPU__DOT__PC_EX = VL_RAND_RESET_I(32);
    vlSelf->PipelineCPU__DOT__PC_plus4_EX = VL_RAND_RESET_I(32);
    vlSelf->PipelineCPU__DOT__memRead_EX = VL_RAND_RESET_I(1);
    vlSelf->PipelineCPU__DOT__memWrite_EX = VL_RAND_RESET_I(1);
    vlSelf->PipelineCPU__DOT__ALUSrc_EX = VL_RAND_RESET_I(1);
    vlSelf->PipelineCPU__DOT__regWrite_EX = VL_RAND_RESET_I(1);
    vlSelf->PipelineCPU__DOT__funct3_EX = VL_RAND_RESET_I(3);
    vlSelf->PipelineCPU__DOT__funct7_EX = VL_RAND_RESET_I(7);
    vlSelf->PipelineCPU__DOT__memtoReg_EX = VL_RAND_RESET_I(2);
    vlSelf->PipelineCPU__DOT__ALUOp_EX = VL_RAND_RESET_I(2);
    vlSelf->PipelineCPU__DOT__rd1_EX = VL_RAND_RESET_I(32);
    vlSelf->PipelineCPU__DOT__rd2_EX = VL_RAND_RESET_I(32);
    vlSelf->PipelineCPU__DOT__imm_EX = VL_RAND_RESET_I(32);
    vlSelf->PipelineCPU__DOT__ALU_result_EX = VL_RAND_RESET_I(32);
    vlSelf->PipelineCPU__DOT__inst_EX = VL_RAND_RESET_I(32);
    vlSelf->PipelineCPU__DOT__inst_MEM = VL_RAND_RESET_I(32);
    vlSelf->PipelineCPU__DOT__PC_mem = VL_RAND_RESET_I(32);
    vlSelf->PipelineCPU__DOT__memRead_mem = VL_RAND_RESET_I(1);
    vlSelf->PipelineCPU__DOT__memWrite_mem = VL_RAND_RESET_I(1);
    vlSelf->PipelineCPU__DOT__regWrite_mem = VL_RAND_RESET_I(1);
    vlSelf->PipelineCPU__DOT__memtoReg_mem = VL_RAND_RESET_I(2);
    vlSelf->PipelineCPU__DOT__ALU_result_mem = VL_RAND_RESET_I(32);
    vlSelf->PipelineCPU__DOT__rd2_mem = VL_RAND_RESET_I(32);
    vlSelf->PipelineCPU__DOT__rd_mem = VL_RAND_RESET_I(32);
    vlSelf->PipelineCPU__DOT__rd_WB = VL_RAND_RESET_I(32);
    vlSelf->PipelineCPU__DOT__ALU_result_ID = VL_RAND_RESET_I(1);
    vlSelf->PipelineCPU__DOT__PC_WB = VL_RAND_RESET_I(32);
    vlSelf->PipelineCPU__DOT__ALU_result_WB = VL_RAND_RESET_I(32);
    vlSelf->PipelineCPU__DOT__memRdata_WB = VL_RAND_RESET_I(32);
    vlSelf->PipelineCPU__DOT__memtoReg_WB = VL_RAND_RESET_I(2);
    vlSelf->PipelineCPU__DOT__PC_muxed = VL_RAND_RESET_I(32);
    vlSelf->PipelineCPU__DOT__RePC = VL_RAND_RESET_I(1);
    vlSelf->PipelineCPU__DOT__Flush_HD = VL_RAND_RESET_I(1);
    vlSelf->PipelineCPU__DOT__rd1_muxed = VL_RAND_RESET_I(32);
    vlSelf->PipelineCPU__DOT__rd2_muxed = VL_RAND_RESET_I(32);
    vlSelf->PipelineCPU__DOT__EX_ForwardA = VL_RAND_RESET_I(2);
    vlSelf->PipelineCPU__DOT__EX_ForwardB = VL_RAND_RESET_I(2);
    vlSelf->PipelineCPU__DOT__ID_ForwardA = VL_RAND_RESET_I(2);
    vlSelf->PipelineCPU__DOT__ID_ForwardB = VL_RAND_RESET_I(2);
    vlSelf->PipelineCPU__DOT__ForwardA_EX = VL_RAND_RESET_I(32);
    vlSelf->PipelineCPU__DOT__ForwardB_EX = VL_RAND_RESET_I(32);
    vlSelf->PipelineCPU__DOT__ForwardA_ID = VL_RAND_RESET_I(32);
    vlSelf->PipelineCPU__DOT__ForwardB_ID = VL_RAND_RESET_I(32);
    vlSelf->PipelineCPU__DOT__ForwardA_EX_out = VL_RAND_RESET_I(32);
    vlSelf->PipelineCPU__DOT__ForwardB_EX_out = VL_RAND_RESET_I(32);
    vlSelf->PipelineCPU__DOT__ForwardB_MEM_out = VL_RAND_RESET_I(32);
    vlSelf->PipelineCPU__DOT__RS1E_data = VL_RAND_RESET_I(32);
    vlSelf->PipelineCPU__DOT__RS2E_data = VL_RAND_RESET_I(32);
    vlSelf->PipelineCPU__DOT__PC_4_WB = VL_RAND_RESET_I(32);
    vlSelf->PipelineCPU__DOT__adder_2_src = VL_RAND_RESET_I(32);
    for (int __Vi0 = 0; __Vi0 < 128; ++__Vi0) {
        vlSelf->PipelineCPU__DOT__m_InstMem__DOT__insts[__Vi0] = VL_RAND_RESET_I(8);
    }
    vlSelf->PipelineCPU__DOT__m_Control__DOT__ctrl = VL_RAND_RESET_I(12);
    for (int __Vi0 = 0; __Vi0 < 32; ++__Vi0) {
    ...
    vlSelf->__Vdly__PipelineCPU__DOT__inst_ID = VL_RAND_RESET_I(32);
    vlSelf->__Vdly__PipelineCPU__DOT__PC_plus4_ID = VL_RAND_RESET_I(32);
    ...
    vlSelf->__Vtrigrprev__TOP__PipelineCPU__DOT__ALU_result_mem = VL_RAND_RESET_I(32);
