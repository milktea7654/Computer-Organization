module Forwarding_Unit (
    ...
    always @(*) begin
        ...
        if ((id_R2 != 0 && ex_RegWrite && (ex_Rd == id_R2)))
            id_ForwardB = 2'b11;
        else if (id_R2 != 0 && mem_RegWrite&& (mem_Rd == id_R2))
            id_ForwardB = 2'b01;
        else if (id_R2 != 0 && wb_RegWrite && (wb_Rd  == id_R2))
            id_ForwardB = 2'b10;
        else
            id_ForwardB = 2'b00;

        if (id_R1 != 0 && ex_RegWrite && (ex_Rd == id_R1))
            id_ForwardA = 2'b11;
        else if (id_R1 != 0 && mem_RegWrite && (mem_Rd == id_R1))
            id_ForwardA = 2'b01;
        else if (wb_Rd != 0 && wb_RegWrite  && (wb_Rd  == id_R1))
            id_ForwardA = 2'b10;
        else
            id_ForwardA = 2'b00;
