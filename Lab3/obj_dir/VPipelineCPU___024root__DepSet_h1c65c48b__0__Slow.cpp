    ...
    if ((0x40U & vlSelf->PipelineCPU__DOT__inst_ID)) {
        if ((0x20U & vlSelf->PipelineCPU__DOT__inst_ID)) {
            if ((0x10U & vlSelf->PipelineCPU__DOT__inst_ID)) {
                ...
                vlSelf->PipelineCPU__DOT__PCSel_ID = 0U;
            } else if ((8U & vlSelf->PipelineCPU__DOT__inst_ID)) {
                if ((4U & vlSelf->PipelineCPU__DOT__inst_ID)) {
                    if ((2U & vlSelf->PipelineCPU__DOT__inst_ID)) {
                                                 ...
                                                 | ((0xff000U 
                                                    ...
                                                    | ((0x800U 
                                                       ...
                                                       | (0x7feU 
                                                          & (vlSelf->PipelineCPU__DOT__inst_ID 
                                                             >> 0x14U))))));
                            vlSelf->PipelineCPU__DOT__PCSel_ID = 1U;
                        } else {
                            vlSelf->PipelineCPU__DOT__imm_ID = 0U;
                            vlSelf->PipelineCPU__DOT__PCSel_ID = 0U;
                        }
                        ...
                        vlSelf->PipelineCPU__DOT__imm_ID 
                            = (((- (IData)((vlSelf->PipelineCPU__DOT__inst_ID 
                                ...
                                << 0xcU) | (vlSelf->PipelineCPU__DOT__inst_ID 
                                            >> 0x14U));
                        vlSelf->PipelineCPU__DOT__PCSel_ID = 2U;
                    } else {
                        vlSelf->PipelineCPU__DOT__imm_ID = 0U;
                        vlSelf->PipelineCPU__DOT__PCSel_ID = 0U;
                    }
                                        ...
                                        | ((0x800U 
                                           ...
                                           | ((0x7e0U 
                                              ...
                                              | (0x1eU 
                                                 & (vlSelf->PipelineCPU__DOT__inst_ID 
                                                    >> 7U))))));
                    vlSelf->PipelineCPU__DOT__PCSel_ID 
                        = ((0x4000U & vlSelf->PipelineCPU__DOT__inst_ID)
                            ? ((0x2000U & vlSelf->PipelineCPU__DOT__inst_ID)
                                ? 0U : ((0x1000U & vlSelf->PipelineCPU__DOT__inst_ID)
                                         ? ((1U & (
        ...
        vlSelf->PipelineCPU__DOT__imm_ID = ((0x20U 
                                             & vlSelf->PipelineCPU__DOT__inst_ID)
                                             ? ((0x10U 
                                                 & vlSelf->PipelineCPU__DOT__inst_ID)
                                                 ? 0U
...
VL_ATTR_COLD void VPipelineCPU___024root___dump_triggers__act(VPipelineCPU___024root* vlSelf) {
    ...
    if (vlSelf->__VactTriggered.at(4U)) {
        VL_DBG_MSGF("         'act' region trigger index 4 is active: @(posedge clk or posedge start)\n");
    }
}
#endif  // VL_DEBUG
...
VL_ATTR_COLD void VPipelineCPU___024root___dump_triggers__nba(VPipelineCPU___024root* vlSelf) {
    ...
    if (vlSelf->__VnbaTriggered.at(4U)) {
        VL_DBG_MSGF("         'nba' region trigger index 4 is active: @(posedge clk or posedge start)\n");
    }
}
#endif  // VL_DEBUG
...
VL_ATTR_COLD void VPipelineCPU___024root___ctor_var_reset(VPipelineCPU___024root* vlSelf) {
    ...
    vlSelf->PipelineCPU__DOT__rd1 = VL_RAND_RESET_I(32);
    vlSelf->PipelineCPU__DOT__rd2 = VL_RAND_RESET_I(32);
    ...
    vlSelf->PipelineCPU__DOT____Vcellout__m_ID_EX_Reg__ctrl_IDEX_o = VL_RAND_RESET_I(18);
    vlSelf->PipelineCPU__DOT____Vcellinp__m_ID_EX_Reg__ctrl_IDEX_i = VL_RAND_RESET_I(18);
    vlSelf->PipelineCPU__DOT____Vcellout__m_EX_MEM_Reg__WB_M_control_o = VL_RAND_RESET_I(5);
    vlSelf->PipelineCPU__DOT____Vcellout__m_MEM_WB_Reg__ctrl_WB_o = VL_RAND_RESET_I(3);
