...
VL_ATTR_COLD void VSingleCycleCPU___024root__trace_init_sub__TOP__0(VSingleCycleCPU___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    tracep->declBit(c+62,"rst_n", false,-1);
    tracep->declBus(c+52,"PC_INPUT", false,-1, 31,0);
    ...
    tracep->declBus(c+53,"PCSel", false,-1, 1,0);
    ...
    tracep->declBus(c+95,"write_back", false,-1, 31,0);
    tracep->declBit(c+56,"BrEq", false,-1);
    tracep->declBit(c+57,"BrLT", false,-1);
    tracep->declBus(c+47,"imm", false,-1, 31,0);
    tracep->declBus(c+48,"shifted_imm", false,-1, 31,0);
    tracep->declBus(c+97,"pc_j_to", false,-1, 31,0);
    tracep->declBus(c+49,"pc_branch", false,-1, 31,0);
    tracep->declBus(c+58,"ALU_in2", false,-1, 31,0);
    tracep->declBus(c+50,"ALUCtl", false,-1, 3,0);
    tracep->declBus(c+59,"ALU_result", false,-1, 31,0);
    tracep->declBit(c+60,"zero", false,-1);
    tracep->declBus(c+96,"mem_data", false,-1, 31,0);
    ...
    tracep->declBus(c+98,"a", false,-1, 31,0);
    ...
    tracep->declBus(c+99,"size", false,-1, 31,0);
    tracep->declBus(c+53,"sel", false,-1, 1,0);
    tracep->declBus(c+46,"s0", false,-1, 31,0);
    tracep->declBus(c+49,"s1", false,-1, 31,0);
    tracep->declBus(c+59,"s2", false,-1, 31,0);
    ...
    tracep->declBit(c+62,"rst", false,-1);
    tracep->declBit(c+43,"regWrite", false,-1);
    tracep->declBus(c+37,"readReg1", false,-1, 4,0);
    tracep->declBus(c+38,"readReg2", false,-1, 4,0);
...
VL_ATTR_COLD void VSingleCycleCPU___024root__trace_full_sub_0(VSingleCycleCPU___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    bufp->fullIData(oldp+33,(vlSelf->SingleCycleCPU__DOT__PC),32);
    bufp->fullCData(oldp+34,(vlSelf->SingleCycleCPU__DOT__opcode),7);
    bufp->fullCData(oldp+35,(vlSelf->SingleCycleCPU__DOT__funct3),3);
    bufp->fullCData(oldp+36,(vlSelf->SingleCycleCPU__DOT__funct7),7);
    bufp->fullCData(oldp+37,(((0x80U <= vlSelf->SingleCycleCPU__DOT__PC)
                               ? 0U : (0x1fU & (vlSelf->__VdfgTmp_h30fffff8__0 
                                                >> 0xfU)))),5);
    bufp->fullCData(oldp+38,(((0x80U <= vlSelf->SingleCycleCPU__DOT__PC)
                               ? 0U : (0x1fU & (vlSelf->__VdfgTmp_h75522435__0 
                                                >> 0x14U)))),5);
    bufp->fullCData(oldp+39,(vlSelf->SingleCycleCPU__DOT__rd),5);
    bufp->fullBit(oldp+40,(vlSelf->SingleCycleCPU__DOT__memRead));
    bufp->fullBit(oldp+41,(vlSelf->SingleCycleCPU__DOT__memWrite));
    bufp->fullBit(oldp+42,(vlSelf->SingleCycleCPU__DOT__ALUSrc));
    bufp->fullBit(oldp+43,(vlSelf->SingleCycleCPU__DOT__regWrite));
    bufp->fullCData(oldp+44,(vlSelf->SingleCycleCPU__DOT__memtoReg),2);
    bufp->fullCData(oldp+45,(vlSelf->SingleCycleCPU__DOT__ALUOp),2);
    bufp->fullIData(oldp+46,(((IData)(4U) + vlSelf->SingleCycleCPU__DOT__PC)),32);
    bufp->fullIData(oldp+47,(vlSelf->SingleCycleCPU__DOT__imm),32);
    bufp->fullIData(oldp+48,((vlSelf->SingleCycleCPU__DOT__imm 
                              << 1U)),32);
    bufp->fullIData(oldp+49,((vlSelf->SingleCycleCPU__DOT__PC 
                              + vlSelf->SingleCycleCPU__DOT__imm)),32);
    bufp->fullCData(oldp+50,(vlSelf->SingleCycleCPU__DOT__ALUCtl),4);
    bufp->fullIData(oldp+51,(vlSelf->SingleCycleCPU__DOT__inst),32);
    bufp->fullIData(oldp+52,(vlSelf->SingleCycleCPU__DOT__PC_INPUT),32);
    bufp->fullCData(oldp+53,(vlSelf->SingleCycleCPU__DOT__PCSel),2);
    bufp->fullIData(oldp+54,(vlSelf->SingleCycleCPU__DOT__rd1),32);
    bufp->fullIData(oldp+55,(vlSelf->SingleCycleCPU__DOT__rd2),32);
    bufp->fullBit(oldp+56,(vlSelf->SingleCycleCPU__DOT__BrEq));
    bufp->fullBit(oldp+57,(vlSelf->SingleCycleCPU__DOT__BrLT));
    bufp->fullIData(oldp+58,(vlSelf->SingleCycleCPU__DOT__ALU_in2),32);
    bufp->fullIData(oldp+59,(vlSelf->SingleCycleCPU__DOT__ALU_result),32);
    bufp->fullBit(oldp+60,((0U == vlSelf->SingleCycleCPU__DOT__ALU_result)));
    ...
    bufp->fullIData(oldp+95,(vlSelf->SingleCycleCPU__DOT__write_back),32);
    bufp->fullIData(oldp+96,(vlSelf->SingleCycleCPU__DOT__mem_data),32);
    bufp->fullIData(oldp+97,(vlSelf->SingleCycleCPU__DOT__pc_j_to),32);
