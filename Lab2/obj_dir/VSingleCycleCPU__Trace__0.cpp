...
void VSingleCycleCPU___024root__trace_chg_sub_0(VSingleCycleCPU___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    if (VL_UNLIKELY(vlSelf->__Vm_traceActivity[2U])) {
        bufp->chgIData(oldp+32,(vlSelf->SingleCycleCPU__DOT__PC),32);
        bufp->chgCData(oldp+33,(vlSelf->SingleCycleCPU__DOT__opcode),7);
        bufp->chgCData(oldp+34,(vlSelf->SingleCycleCPU__DOT__funct3),3);
        bufp->chgCData(oldp+35,(vlSelf->SingleCycleCPU__DOT__funct7),7);
        bufp->chgCData(oldp+36,(((0x80U <= vlSelf->SingleCycleCPU__DOT__PC)
                                  ? 0U : (0x1fU & (vlSelf->__VdfgTmp_h30fffff8__0 
                                                   >> 0xfU)))),5);
        bufp->chgCData(oldp+37,(((0x80U <= vlSelf->SingleCycleCPU__DOT__PC)
                                  ? 0U : (0x1fU & (vlSelf->__VdfgTmp_h75522435__0 
                                                   >> 0x14U)))),5);
        bufp->chgCData(oldp+38,(vlSelf->SingleCycleCPU__DOT__rd),5);
        bufp->chgBit(oldp+39,(vlSelf->SingleCycleCPU__DOT__memRead));
        bufp->chgBit(oldp+40,(vlSelf->SingleCycleCPU__DOT__memWrite));
        bufp->chgBit(oldp+41,(vlSelf->SingleCycleCPU__DOT__ALUSrc));
        bufp->chgBit(oldp+42,(vlSelf->SingleCycleCPU__DOT__regWrite));
        bufp->chgCData(oldp+43,(vlSelf->SingleCycleCPU__DOT__memtoReg),2);
        bufp->chgCData(oldp+44,(vlSelf->SingleCycleCPU__DOT__ALUOp),2);
        bufp->chgIData(oldp+45,(((IData)(4U) + vlSelf->SingleCycleCPU__DOT__PC)),32);
        bufp->chgIData(oldp+46,(vlSelf->SingleCycleCPU__DOT__imm),32);
        bufp->chgIData(oldp+47,((vlSelf->SingleCycleCPU__DOT__imm 
                                 << 1U)),32);
        bufp->chgIData(oldp+48,((vlSelf->SingleCycleCPU__DOT__PC 
                                 + vlSelf->SingleCycleCPU__DOT__imm)),32);
        bufp->chgCData(oldp+49,(vlSelf->SingleCycleCPU__DOT__ALUCtl),4);
        bufp->chgIData(oldp+50,(vlSelf->SingleCycleCPU__DOT__inst),32);
    }
    if (VL_UNLIKELY(vlSelf->__Vm_traceActivity[3U])) {
        bufp->chgIData(oldp+51,(vlSelf->SingleCycleCPU__DOT__PC_INPUT),32);
        bufp->chgCData(oldp+52,(vlSelf->SingleCycleCPU__DOT__PCSel),2);
        bufp->chgIData(oldp+53,(vlSelf->SingleCycleCPU__DOT__rd1),32);
        bufp->chgIData(oldp+54,(vlSelf->SingleCycleCPU__DOT__rd2),32);
        bufp->chgBit(oldp+55,(vlSelf->SingleCycleCPU__DOT__BrEq));
        bufp->chgBit(oldp+56,(vlSelf->SingleCycleCPU__DOT__BrLT));
        bufp->chgIData(oldp+57,(vlSelf->SingleCycleCPU__DOT__ALU_in2),32);
        bufp->chgIData(oldp+58,(vlSelf->SingleCycleCPU__DOT__ALU_result),32);
        bufp->chgBit(oldp+59,((0U == vlSelf->SingleCycleCPU__DOT__ALU_result)));
    }
    ...
    bufp->chgIData(oldp+94,(vlSelf->SingleCycleCPU__DOT__write_back),32);
    bufp->chgIData(oldp+95,(vlSelf->SingleCycleCPU__DOT__mem_data),32);
}
